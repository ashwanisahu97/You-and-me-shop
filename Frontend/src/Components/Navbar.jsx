...
const Navbar = () => {
  ...
  return (
    <Flex fontFamily={`Whitney, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif`} fontSize={"20px"} color={ "#282c3f"} fontWeight="500" lineHeight="80px" position="fixed" zIndex={"1"} gap="30px" alignItems={"center"} bg="#f7f8f7" w={"100%"}>
