  ...
  return (
    ...
    <Flex>
      ...
      <Flex h="50px" border={"1px solid red"} justifyContent={"space-between"}>
        <Flex onClick={() => {
          navigate("/cart")
        }} backgroundColor={"tomato"} _hover={{cursor:"pointer"}} color="white" gap="10px" justifyContent="center" borderRadius="10px" border="1px solid green" alignItems="center" fontSize={"2xl"} fontStyle="Whitney" w={"45%"}>
         <Box><BsCartFill/></Box> 
